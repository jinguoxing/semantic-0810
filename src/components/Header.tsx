...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-[64px] bg-white border-b border-[#E2E8F0] px-6 flex items-center justify-between sticky top-0 z-30 shadow-xs shrink-0">
      ...
      <div className="flex items-center space-x-4">
        ...
        <nav className="hidden lg:flex items-center space-x-1 ml-4 border-l border-[#E2E8F0] pl-6">
          <button
            ...
            className={`px-3 py-1.5 text-xs font-semibold rounded-md transition-colors flex items-center space-x-1 cursor-pointer ${
              currentNav === 'home'
                ? 'text-[#4F46E5] bg-[#EEF2FF] border-b-2 border-[#4F46E5]'
      ...
      <div className="flex items-center space-x-3">
        {/* Org Selector */}
        <div className="hidden xl:flex items-center space-x-1.5 px-2.5 py-1 rounded-lg bg-slate-50 border border-slate-200 text-xs text-slate-700 font-medium cursor-pointer hover:border-slate-300 transition-colors">
        ...
        <button 
          onClick={onReanalyze}
          className="px-2.5 py-1 text-xs font-medium text-[#4F46E5] bg-[#EEF2FF] hover:bg-[#E0E7FF] border border-[#4F46E5]/30 rounded-md transition-colors flex items-center space-x-1 cursor-pointer"
        >
        ...
        <button 
          ...
          className="px-2.5 py-1 text-xs font-medium text-[#475569] bg-white hover:bg-[#F1F5F9] border border-[#E2E8F0] rounded-md transition-colors flex items-center space-x-1 cursor-pointer"
        >
        ...
        <button 
          ...
          className="px-2.5 py-1 text-xs font-semibold text-white bg-[#4F46E5] hover:bg-[#4338CA] rounded-md transition-colors flex items-center space-x-1 shadow-2xs cursor-pointer"
        >
        ...
        <button
          ...
          className={`flex items-center space-x-2 pl-1 cursor-pointer rounded-full transition-all relative ${
            isProfileOpen ? 'ring-2 ring-[#4F46E5] ring-offset-2' : 'hover:opacity-80'
          }`}
          title="个人中心"
        >
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-indigo-600 via-indigo-500 to-purple-600 text-white font-bold text-xs border border-white flex items-center justify-center shadow-xs">
            <span>A</span>
          </div>
        </button>
      </div>

      ...
      <div className="flex items-center space-x-6">
        ...
        <nav className="hidden lg:flex items-center space-x-1 text-xs font-semibold text-[#475569]">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md transition-colors cursor-pointer ${
              currentNav === 'marketplace' || currentNav === 'marketplace_resources' || currentNav === 'asset_detail' || currentNav === 'api_detail' || currentNav === 'multi_resource_request' || currentNav === 'my_requests'

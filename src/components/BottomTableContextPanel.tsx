...
export const BottomTableContextPanel: React.FC = () => {
  return (
    <footer className="h-[220px] bg-white border-t border-[#E2E8F0] p-3 md:p-4 flex flex-col md:flex-row items-stretch justify-between gap-3 shrink-0 shadow-2xs overflow-y-auto">

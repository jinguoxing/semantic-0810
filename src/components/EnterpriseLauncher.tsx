      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-start justify-start p-4 md:p-6 lg:p-8 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-[580px] bg-white rounded-3xl border border-slate-200/90 shadow-2xl shadow-indigo-950/20 overflow-hidden my-auto sm:my-0 flex flex-col"
            style={{ maxHeight: 'calc(100vh - 48px)' }}
          >
            {/* Top Header Region */}
            <div className="px-6 pt-5 pb-4 border-b border-slate-100 flex items-start justify-between bg-gradient-to-r from-slate-50/80 via-white to-indigo-50/30">
              <div className="flex items-start space-x-3">
                <div className="w-10 h-10 rounded-2xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-[#4F46E5] shadow-2xs mt-0.5">
                  <Grid className="w-5 h-5 text-[#4F46E5]" />
                </div>
                <div>
                  <div className="flex items-center space-x-2">
                    <h2 className="text-base font-bold text-slate-900 tracking-tight">应用中心</h2>
                    <span className="text-[11px] font-bold px-2 py-0.5 rounded-full bg-indigo-50 text-[#4F46E5] border border-indigo-200/60 shadow-2xs">
                      全量模块
                    </span>
                  </div>
            ...
            <div className="p-6 space-y-6 overflow-y-auto flex-1 custom-scrollbar">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div
                    ...
                    className={`group relative p-3.5 rounded-2xl border transition-all cursor-pointer flex flex-col justify-between ${
                      currentModule === 'xino_partner'
                        ? 'border-[#6366F1] bg-gradient-to-b from-[#F5F3FF] via-indigo-50/20 to-white ring-2 ring-[#6366F1]/20 shadow-md shadow-indigo-500/10'
                        : 'border-slate-200/90 bg-white hover:border-indigo-300 hover:shadow-md'
                    }`}
                  >
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-600 via-indigo-500 to-purple-600 text-white flex items-center justify-center shadow-xs">
                          <Bot className="w-5 h-5 text-white" />
                        </div>
                        <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-[#4F46E5] text-white shadow-2xs">
                          当前
                        </span>
                      </div>
                      <h4 className="text-sm font-bold text-slate-900 group-hover:text-[#4F46E5] transition-colors">
                        Xino 智能伙伴
                      </h4>
                    ...
                    <div className="flex items-center justify-end mt-3 pt-2 border-t border-indigo-100/60">
                      <ChevronRight className="w-4 h-4 text-[#4F46E5] group-hover:translate-x-0.5 transition-transform" />
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    className="group relative p-3.5 rounded-2xl border border-slate-200/90 bg-white hover:border-indigo-300 hover:shadow-md transition-all cursor-pointer flex flex-col justify-between"
                  >
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-purple-600 to-indigo-700 text-white flex items-center justify-center shadow-xs">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div
                    ...
                    className="group p-3.5 rounded-2xl border border-slate-200/90 bg-white hover:border-indigo-300 hover:shadow-md transition-all cursor-pointer flex flex-col justify-between"
                  >
                    <div>
                      <div className="w-9 h-9 rounded-xl bg-purple-50 border border-purple-200/60 flex items-center justify-center text-purple-600 mb-2">
                  ...
                  <div
                    ...
                    className="group p-3.5 rounded-2xl border border-slate-200/90 bg-white hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer flex flex-col justify-between"
                  >
                    <div>
                      <div className="w-9 h-9 rounded-xl bg-emerald-50 border border-emerald-200/60 flex items-center justify-center text-emerald-600 mb-2">
                  ...
                  <div
                    ...
                    className="group p-3.5 rounded-2xl border border-slate-200/90 bg-white hover:border-blue-300 hover:shadow-md transition-all cursor-pointer flex flex-col justify-between"
                  >
                    <div>
                      <div className="w-9 h-9 rounded-xl bg-blue-50 border border-blue-200/60 flex items-center justify-center text-blue-600 mb-2">
                  ...
                  >
                    <div>
                      <div className="w-9 h-9 rounded-xl bg-indigo-50 border border-indigo-200/60 flex items-center justify-center text-[#4F46E5] mb-2">
              ...
              <div>
                ...
                <div
                  ...
                  className="group p-3.5 rounded-2xl border border-slate-200/90 bg-white hover:border-slate-400 hover:shadow-md transition-all cursor-pointer flex flex-col justify-between"
                >
